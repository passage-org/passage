 ...
 * call our {@link SagerOpExecutor}, we create and register our engine. We add a necessary
 * counter in top of the execution pipeline.
 */
public class SagerQueryEngine extends QueryEngineBase {

    private static Logger log = LoggerFactory.getLogger(SagerQueryEngine.class);

    protected SagerQueryEngine(Op op, DatasetGraph dataset, Binding input, Context context) {
        super(op, dataset, input, context);
    }

    protected SagerQueryEngine(Query query, DatasetGraph dataset, Binding input, Context cxt) {
    ...
    static public void unregister() {
        QueryEngineRegistry.removeFactory(SagerQueryEngine.factory);
    }
    ...
    public static class SagerQueryEngineFactory implements QueryEngineFactory {
        ...
        public Plan create(Query query, DatasetGraph dataset, Binding inputBinding, Context context) {
            return new SagerQueryEngine(query, dataset, inputBinding, context).getPlan();
        }
        ...
        public Plan create(Op op, DatasetGraph dataset, Binding inputBinding, Context context) {
            return new SagerQueryEngine(op, dataset, inputBinding, context).getPlan();
        }
    }
}
