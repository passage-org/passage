 ...
 */
public interface Backend<ID, VALUE> extends AutoCloseable {
     ...
     */
    BackendIterator<ID, VALUE> search(final ID s, final ID p, final ID o);
     ...
     */
    BackendIterator<ID, VALUE> search(final ID s, final ID p, final ID o, final ID c);
     ...
     */
    default BackendIterator<ID, VALUE> searchDistinct(final ID s, final ID p, final ID o, Set<Integer> codes) {
     ...
     * @return A scan iterators on distinct values, that allows skipping to an offset.
     */
    default BackendIterator<ID, VALUE> searchDistinct(final ID s, final ID p, final ID o, final ID c, Set<Integer> codes) {
        throw new UnsupportedOperationException(); // not mandatory
    }
