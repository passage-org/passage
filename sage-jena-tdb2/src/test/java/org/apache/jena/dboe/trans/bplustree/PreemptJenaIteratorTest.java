...
public class PreemptJenaIteratorTest {
    ...
    public void check_every_steps_of_preempt_with_singleton_at_the_end() {
        // #A first run to check that singleton works well
        SageOutput<SerializableRecord> output = execute_vpv_then_spo_till_end(Long.MAX_VALUE);
    ...
    private SageOutput<SerializableRecord> execute_vpv_then_spo_till_end(long timeout) {
        SageOutput<SerializableRecord> partialOutput = null;
        SageOutput<SerializableRecord> output = new SageOutput<>();
    ...
    private SageOutput<SerializableRecord> execute_vpv_then_spo(SageInput<SerializableRecord> input) {
