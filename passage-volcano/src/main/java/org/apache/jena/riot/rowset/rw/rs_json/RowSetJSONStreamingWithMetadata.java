 ...
 */
public class RowSetJSONStreamingWithMetadata<E> extends IteratorSlotted<Binding> implements RowSet {
    /* Construction -------------------------------------------------------- */

    public static RowSetBuffered<RowSetJSONStreamingWithMetadata<?>> createBuffered(
    ...
    public Op continuationQuery;

    public static RowSetJSONStreamingWithMetadata<?> createUnbuffered(InputStream in, LabelToNode labelMap, ValidationSettings validationSettings,
                                                                                                 ErrorHandler errorHandler) {
        Gson gson = new Gson();
        ...
        //        RowSetJSONStreamingWithMetadata.UnexpectedJsonEltHandler unexpectedJsonHandler = (_gson, _reader) -> {
        ...
        //            return null;
        //        };
        ExpectedMetadata unexpectedJsonHandler = new ExpectedMetadata(errorHandler, validationSettings);
        ...
        RsJsonEltEncoder<RowSetJSONStreamingWithMetadata.RsJsonEltDft> eltEncoder = new RsJsonEltEncoderDft(labelMap, null, unexpectedJsonHandler);
        RowSetJSONStreamingWithMetadata.RsJsonEltDecoder<RowSetJSONStreamingWithMetadata.RsJsonEltDft> eltDecoder = RowSetJSONStreamingWithMetadata.RsJsonEltDecoderDft.INSTANCE;
        IteratorRsJSON<RsJsonEltDft> eltIt = new IteratorRsJSON<>(gson, reader, eltEncoder);

        // Wrap this up as a validating RowSet
        RowSetJSONStreamingWithMetadata<?> result = new RowSetJSONStreamingWithMetadata<>(eltIt, eltDecoder, 0l, validationSettings, errorHandler);
        unexpectedJsonHandler.setParent(result);
        return result;
    }
    ...
    private static class RsJsonEltDft {
        ...
        public RsJsonEltDft(List<Var> head) {
            this.type = RowSetJSONStreamingWithMetadata.RsJsonEltType.HEAD;
            this.head = head;
        }

        public RsJsonEltDft(Boolean askResult) {
            this.type = RowSetJSONStreamingWithMetadata.RsJsonEltType.BOOLEAN;
            this.askResult = askResult;
        }

        public RsJsonEltDft(Binding binding) {
            this.type = RowSetJSONStreamingWithMetadata.RsJsonEltType.BINDING;
            this.binding = binding;
        }

        public RsJsonEltDft(Object jsonElement) {
            this.type = RowSetJSONStreamingWithMetadata.RsJsonEltType.UNKNOWN;
            this.unknownJsonElement = jsonElement;
        }

        public RowSetJSONStreamingWithMetadata.RsJsonEltType getType() {
            return type;
        }
    ...
    protected RowSetJSONStreamingWithMetadata.RsJsonEltDecoder<? super E> eltDecoder;
    protected long rowNumber;

    protected ValidationSettings validationSettings;
    protected ErrorHandler errorHandler;

    protected RowSetJSONStreamingWithMetadata.TentativeValue<List<Var>> resultVars = null;
    protected RowSetJSONStreamingWithMetadata.TentativeValue<Boolean> askResult = null;
    ...
    private RowSetJSONStreamingWithMetadata(
        ...
        this.resultVars = new RowSetJSONStreamingWithMetadata.TentativeValue<>();
        this.askResult = new RowSetJSONStreamingWithMetadata.TentativeValue<>();
    }
    ...
    static void validate(RowSetJSONStreamingWithMetadata<?> rs, ErrorHandler errorHandler, ValidationSettings settings) {
     ...
     */
    private static void validateCompleted(RowSetJSONStreamingWithMetadata<?> rs, ErrorHandler errorHandler, ValidationSettings settings) {
    ...
    /**
     * A decoder can extract an instance of E's {@link RowSetJSONStreamingWithMetadata.RsJsonEltType} an provides
     * methods to extract the corresponding value. It decouples
     * {@link org.apache.jena.riot.rowset.rw.rs_json.RowSetJSONStreaming} from gson.
     */
    ...
    /** Decoder for extraction of rs-json domain objects from {@link .RowSetJSONStreaming.RsJsonEltDft} */
    private static class RsJsonEltDecoderDft implements RowSetJSONStreamingWithMetadata.RsJsonEltDecoder<RowSetJSONStreamingWithMetadata.RsJsonEltDft> {
        static final RsJsonEltDecoderDft INSTANCE = new RowSetJSONStreamingWithMetadata.RsJsonEltDecoderDft();

        private RsJsonEltDecoderDft() {}

        @Override public RowSetJSONStreamingWithMetadata.RsJsonEltType getType(RowSetJSONStreamingWithMetadata.RsJsonEltDft elt) { return elt.getType(); }
        @Override public Binding getAsBinding(RowSetJSONStreamingWithMetadata.RsJsonEltDft elt)  { return elt.getBinding(); }
        @Override public List<Var> getAsHead(RowSetJSONStreamingWithMetadata.RsJsonEltDft elt)   { return  elt.getHead(); }
        @Override public Boolean getAsBoolean(RowSetJSONStreamingWithMetadata.RsJsonEltDft elt)  { return elt.getAskResult(); }
    }

    /**
     * Json encoder that wraps each message uniformly as a {@link RowSetJSONStreamingWithMetadata.RsJsonEltDft}.
     */
    private static class RsJsonEltEncoderDft
            implements RsJsonEltEncoder<RowSetJSONStreamingWithMetadata.RsJsonEltDft> {

        protected LabelToNode labelMap;
        protected Function<JsonObject, Node> unknownRdfTermTypeHandler;
        protected RowSetJSONStreamingWithMetadata.UnexpectedJsonEltHandler unexpectedJsonHandler;

        public RsJsonEltEncoderDft(LabelToNode labelMap,
                                   Function<JsonObject, Node> unknownRdfTermTypeHandler,
                                   RowSetJSONStreamingWithMetadata.UnexpectedJsonEltHandler unexpectedJsonHandler) {
            super();
        ...
        @Override
        public RowSetJSONStreamingWithMetadata.RsJsonEltDft newHeadElt(Gson gson, JsonReader reader) throws IOException {
            List<Var> vars = parseHeadVars(gson, reader);
            return new RowSetJSONStreamingWithMetadata.RsJsonEltDft(vars);
        }

        @Override
        public RowSetJSONStreamingWithMetadata.RsJsonEltDft newBooleanElt(Gson gson, JsonReader reader) throws IOException {
            Boolean b = reader.nextBoolean();
            return new RowSetJSONStreamingWithMetadata.RsJsonEltDft(b);
        }

        @Override
        public RowSetJSONStreamingWithMetadata.RsJsonEltDft newBindingElt(Gson gson, JsonReader reader) throws IOException {
            Binding binding = parseBinding(gson, reader, labelMap, unknownRdfTermTypeHandler);
            return new RowSetJSONStreamingWithMetadata.RsJsonEltDft(binding);
        }

        @Override
        public RowSetJSONStreamingWithMetadata.RsJsonEltDft newResultsElt(Gson gson, JsonReader reader) throws IOException {
            return new RowSetJSONStreamingWithMetadata.RsJsonEltDft(RowSetJSONStreamingWithMetadata.RsJsonEltType.RESULTS);
        }

        @Override
        public RowSetJSONStreamingWithMetadata.RsJsonEltDft newUnknownElt(Gson gson, JsonReader reader) throws IOException {
            JsonElement jsonElement = unexpectedJsonHandler == null
                    ? null
                    : unexpectedJsonHandler.apply(gson, reader);
            return new RowSetJSONStreamingWithMetadata.RsJsonEltDft(jsonElement);
        }
    }
