...
//                        new PassageExecutionContext<>(context.getContext().get(BackendConstants.BACKEND));
...
//                Iterator<BackendBindings<ID,VALUE>> iterator = executor.visit(subOp, List.of(new BackendBindings<>()));
//
